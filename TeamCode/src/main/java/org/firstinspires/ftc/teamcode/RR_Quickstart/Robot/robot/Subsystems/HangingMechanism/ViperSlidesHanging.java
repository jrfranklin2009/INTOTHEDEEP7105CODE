...
import static org.firstinspires.ftc.teamcode.RR_Quickstart.Robot.robot.Subsystems.DepositingMechanisms.ArmExtension.GEAR_RATIO;
import static org.firstinspires.ftc.teamcode.RR_Quickstart.Robot.robot.Subsystems.DepositingMechanisms.ArmRotation.COUNTS_PER_REVOLUTION;
...
public class ViperSlidesHanging extends Subsystem {
    ...
    public ViperSlidesHanging(Telemetry telemetry){
    ...
    public void ViperSlideTwoPID(int ref) {
        ...
        if (ref < maxslideconstraint && ref > minslideconstraint) {
            ViperSlideTwo.setPower(controller.calculate(ticksToDegrees(ref), getViperSlideTwoPos()));
    ...
    public void ViperSlideOnePID(int ref){
        ...
        if (ref < maxslideconstraint && ref > minslideconstraint){
            ViperSlideOne.setPower(controller.calculate(ticksToDegrees(ref), getViperSlideOnePos()));
            // go to the reference position if it is within acceptable boundaries
        }
        else {
